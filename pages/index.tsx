        ...
        <main className={styles.main}>
          ...
          >
            <div className="relative z-40 w-7/12 sm:w-full">
              <h4 className="name-text ml-1 mb-1 leading-4 tracking-widest text-[#878a8f] sm:text-lg">
                YASINDU NETHMINA
              </h4>
              ...
              <div className="flex items-center sm:mr-1 sm:justify-center">
                <a
                  href="#case-studies"
                  className="case-studies-text view-projects-text name-text text-lg font-bold text-[#0f141e] decoration-[#0f141e] underline-offset-4 duration-500 ease-in-out hover:-translate-y-1 hover:scale-105 sm:text-lg"
                >
                  View Projects
                </a>
                <h6 className="name-text mx-4 mb-1 text-xl font-semibold text-[#878a8f] sm:text-xl">
                  or
                </h6>
                <a
                  href="#about-me"
                  className="read-about-text case-studies-text l name-text text-lg font-bold text-[#0f141e] decoration-[#0f141e] underline-offset-4 duration-500 ease-in-out hover:-translate-y-1 hover:scale-105 sm:text-lg"
                >
                  Read About Me
                </a>
              </div>
